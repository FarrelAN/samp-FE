      ...
      <div className="flex flex-row ">
        <div className="flex flex-col">
          <div className="flex flex-col pb-10">
            ...
            <h3 className="text-base text-black py-3">
              <strong>SOC Person in Charge:</strong> {caseData.PIC.PIC_IAM}
            </h3>
          </div>
          <div className="flex flex-col gap-8">
            <div className="lg:col-span-2 space-y-8">
              <div className="flex flex-row space-x-4 items-start justify-start">
                <div className="flex flex-col space-y-4 items-start justify-start min-w-1/2">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md min-w-full">
        ...
        {caseData.case_status.toLowerCase() !== "on progress" ? (
          response ? (
            <div className="space-y-8 w-11/12 mt-12 h-fit mx-8 bg-white p-6 rounded-lg shadow-md">
              <div>
                <h2 className="text-2xl font-semibold text-blue-900 mb-4">
                  Case Status and User Response
                </h2>
                <p>Case has been sent for review to SOC team.</p>
                <p>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md flex flex-col">
                  ...
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <button className="w-fit text-white bg-mandiriBlue-950 hover:bg-mandiriBlue-800 py-3 px-6 rounded-lg transition mb-4 ">
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will send case back to the SOC team for review.
